...
import com.mariomorenoarroyo.proyectofinalkotlin.databinding.FragmentIniciarSesionBinding
...
class IniciarSesionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Usar la vista inflada desde binding
    ...
    private fun iniciarUsarioGoogle() {
